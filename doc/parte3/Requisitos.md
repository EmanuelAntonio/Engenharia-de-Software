...
- **Requisito funcional 12:** Para cada projeto gerado, seus parâmetros de nome da empresa, descricao, valor de pagamento, multa mensal de atraso, tamanho da empresa, experiência do usuário serão definidos de forma aleatória dentro dos mínimos e máximos definidos para o tipo da empresa. Além disso os pontos de prioridade serão definidos a partir dos valores bases para aquele tipo de empresa e serão modificados pelos demais atributos do projeto. Quanto mais próximo o usuário definir dos valores padrão, melhor será a satisfação do cliente no final;
